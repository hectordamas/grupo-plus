...
<div class="card">
    <div class="card-body">
      ...
      <p><strong>Teléfono Fijo:</strong> {{$user->telephoneNumber}}</p>
      <p><strong>Persona de Contacto:</strong> {{$user->name}}</p>
      <p><strong>Teléfono Celular:</strong> {{$user->cellphoneNumber}}</p>
      <p><strong>Email:</strong> {{$user->email}}</p>
      <p><strong>Ciudad:</strong> {{$user->city}}</p>
      <p><strong>RIF:</strong> {{$user->rif}}</p>
    </div>
</div>
          ...
          <table class="table admin-table table-bordered table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center"style="font-size:18px;" id="wireplusPremium">{{number_format($wireplusPremium,2,",",".")}} Bs.S</td>
                <td colspan="2"></td>
              </tr>
              @foreach($cartItems as $cartItem)
              ...
              <tr>
                ...
                <td class="text-center"style="font-size:18px;" id="ledplusPremium">{{number_format($ledplusPremium,2,",",".")}} Bs.S</td>
                <td colspan="2"></td>
              </tr>
            <!--  
            @foreach($cartItems as $cartItem)
              ...
              <tr>
                ...
                <td class="text-center" style="font-size:18px;">{{number_format($totalpkcell,2,".",",")}} $</td>
                <td class="text-center"style="font-size:18px;" >{{number_format($totalpkcellPremium,2,",",".")}} Bs.S</td>
                <td colspan="2"></td>
              </tr>-->
             <!--metalnet-->
              ...
              <tr>
                ...
                <td class="text-center" style="font-size:18px;" id="totalLedplus">{{number_format($totalmetalnet,2,".",",")}} $</td>
                <td class="text-center"style="font-size:18px;" id="ledplusPremium">{{number_format($totalmetalnetPremium,2,",",".")}} Bs.S</td>
                <td colspan="2"></td>
              </tr>
            @foreach($cartItems as $cartItem)
              ...
              <tr>
                ...
                <td class="text-center" style="font-size:18px;" id="totalLedplus">{{number_format($totalRCG,2,".",",")}} $</td>
                <td class="text-center"style="font-size:18px;" id="ledplusPremium">{{number_format($totalRCGPremium,2,",",".")}} Bs.S</td>
                <td colspan="2"></td>
              </tr>
             @foreach($cartItems as $cartItem)
              ...
              <tr>
                ...
                <td class="text-center" style="font-size:18px;" id="totalLedplus">{{number_format($totalMVTEAM,2,".",",")}} $</td>
                <td class="text-center"style="font-size:18px;" id="ledplusPremium">{{number_format($totalMVTEAMPremium,2,",",".")}} Bs.S</td>
                <td colspan="2"></td>
              </tr>
            ...
            @foreach($cartItems as $cartItem)
              ...
              <tr>
                ...
                <td class="text-center" style="font-size:18px;" id="totalLedplus">{{number_format($totalNETVISION,2,".",",")}} $</td>
                <td class="text-center"style="font-size:18px;" id="ledplusPremium">{{number_format($totalNETVISIONPremium,2,",",".")}} Bs.S</td>
                <td colspan="2"></td>
              </tr>
            ...
            @foreach($cartItems as $cartItem)
              ...
              <tr>
                ...
                <td class="text-center" style="font-size:18px;" id="totalLedplus">{{number_format($totalCAPITAL,2,".",",")}} $</td>
                <td class="text-center"style="font-size:18px;" id="ledplusPremium">{{number_format($totalCAPITALPremium,2,",",".")}} Bs.S</td>
                <td colspan="2"></td>
              </tr>
            ...
            @foreach($cartItems as $cartItem)
              ...
              <tr>
                ...
                <td class="text-center" style="font-size:18px;" id="totalLedplus">{{number_format($totalASG,2,".",",")}} $</td>
                <td class="text-center"style="font-size:18px;" id="ledplusPremium">{{number_format($totalASGPremium,2,",",".")}} Bs.S</td>
                <td colspan="2"></td>
              </tr>
            ...
            @foreach($cartItems as $cartItem)
              ...
              <tr>
                ...
                <td class="text-center" style="font-size:18px;" id="totalLedplus">{{number_format($totalECOGREEN,2,".",",")}} $</td>
                <td class="text-center"style="font-size:18px;" id="ledplusPremium">{{number_format($totalECOGREENPremium,2,",",".")}} Bs.S</td>
                <td colspan="2"></td>
              </tr>
              ...
              @endforeach
              <tr>
                <td class="text-center" style="font-size:18px;"><strong>Total en CHUANGO:</strong></td>
                <td class="text-center" style="font-size:18px;" id="totalLedplus">{{number_format($totalCHUANGO,2,".",",")}} $</td>
                <td class="text-center"style="font-size:18px;" id="ledplusPremium">{{number_format($totalCHUANGOPremium,2,",",".")}} Bs.S</td>
                <td colspan="2"></td>
              </tr>
            ...
            @foreach($cartItems as $cartItem)
              ...
              @endforeach
              <tr>
                <td class="text-center" style="font-size:18px;"><strong>Total en HIKVISION:</strong></td>
                <td class="text-center" style="font-size:18px;" id="totalLedplus">{{number_format($totalHIKVISION,2,".",",")}} $</td>
                <td class="text-center"style="font-size:18px;" id="ledplusPremium">{{number_format($totalHIKVISIONPremium,2,",",".")}} Bs.S</td>
                <td colspan="2"></td>
              </tr>
            ...
            @foreach($cartItems as $cartItem)
              ...
              <tr>
                ...
                <td class="text-center" style="font-size:18px;" id="totalLedplus">{{number_format($total3M,2,".",",")}} $</td>
                <td class="text-center"style="font-size:18px;" id="ledplusPremium">{{number_format($total3MPremium,2,",",".")}} Bs.S</td>
                <td colspan="2"></td>
              </tr>
              
                <tr>
                <td class="text-center" style="font-size:18px;"><strong>Base Imponible:</strong></td>
                <td class="text-center" style="font-size:18px;" id="total">{{number_format($subtotal,2,".",",")}} $</td>
                <td class="text-center"style="font-size:18px;" id="totalPremium">{{number_format($subtotalPremium,2,",",".")}} Bs.S</td>
                <td colspan="2"></td>
              </tr>
                <tr>
                <td class="text-center" style="font-size:18px;"><strong>IVA:</strong></td>
                <td class="text-center" style="font-size:18px;" id="total">{{number_format($iva,2,".",",")}} $</td>
                <td class="text-center"style="font-size:18px;" id="totalPremium">{{number_format($ivaPremium,2,",",".")}} Bs.S</td>
                <td colspan="2"></td>
              </tr>
              <tr>
                <td class="text-center" style="font-size:18px;"><strong>Total + IVA:</strong></td>
                <td class="text-center" style="font-size:18px;" id="total">{{$totalReal}} $</td>
                <td class="text-center"style="font-size:18px;" id="totalPremium">{{number_format($totalRealPremium,2,",",".")}} Bs.S</td>
                <td colspan="2"></td>
              </tr>
            </tbody>
          </table>
